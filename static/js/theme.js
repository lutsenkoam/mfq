  ...
  $('.beer-slider').BeerSlider({start: 50});		
	...
	$('.post_team_id1').slick({
			...
			$('.witr_cars11_idtea2').slick({
			 ...
			 var witr_cp = $('.witr_circle_id2');
			  ...
			  witr_cp.circleProgress({
				...
				size: 120,
				lineCap: 'round',
				fill: {  gradient: ["#2F057B", "#6745C5"]}
			  });

			
			$('.carso12_idtesti2').slick({
							infinite: true,
							autoplay: true,
							autoplaySpeed: 3000,
							speed: 700,					
			...
			$('.carso12_idtesti3').slick({
					...
					// TESTIMONIAL hisfull_testomonial_page
		$('.hisfull_testomonial2_active').slick({
			infinite: true,
			autoplay: true,
			autoplaySpeed: 30000,
			speed: 700,					
